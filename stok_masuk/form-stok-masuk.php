...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="../stok_masuk/style-form-stok-masuk.css"/>
        <?php
    ...
    <body>
    <div class="header">
        <header><h2>Daftar Stok Masuk</h2></header>
    </div>
            ...
            <tbody>
                <?php
                    ...
                    if($pencarian == null){
                        ...
                        $query = "SELECT nama_produk, harga, nama_unit, produk.id AS id_produk FROM produk INNER JOIN unit ON unit.id = produk.unit_id LIMIT $halaman_awal, $batas";
                        ...
                        $query = "SELECT nama_produk, harga, nama_unit, produk.id AS id_produk FROM produk INNER JOIN unit ON unit.id = produk.unit_id WHERE nama_produk LIKE '%".$pencarian."%' LIMIT $halaman_awal, $batas";
                        $data_produk = mysqli_query($dbConnection, $query);
                        $nomor = $halaman_awal+1; 
                    }
